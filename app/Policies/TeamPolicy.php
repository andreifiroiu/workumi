...
class TeamPolicy
{
    ...
    /**
     * Determine whether the user can administer the team.
     *
     * Covers workspace settings, AI agents, API keys, integrations, the audit
     * log, billing and member rates. Granted to the owner and the `admin` role.
     */
    public function administer(object $user, object $team): bool
    {
     ...
     *
     * Deleting the whole workspace stays owner-only.
     */
